<?php
class PtsWidgetproduct_tab_banner2 extends PtsWidgetPageBuilder {

		public $name = 'product_tab_banner2';
		public $group = 'product';
        public $usemeneu = false;

		public static function getWidgetInfo(){
			return array('label' => ('Product Tab list banner left'), 'explain' => 'products tab categories banner left', 'group' => 'product'  );
		}
