 		...
 		<div class="products-rows slide" id="productfeatured<?php echo $id;?>">
			...
			<?php } ?>
						...
						<div class="carousel-controls">
							<a class="carousel-control left zmdi zmdi-arrow-left zmdi-hc-fw" href="#productfeatured<?php echo $id;?>" data-slide="prev"></a>
							<a class="carousel-control right zmdi zmdi-arrow-right zmdi-hc-fw" href="#productfeatured<?php echo $id;?>" data-slide="next"></a>
						</div>
						<?php } ?>
