...
<div class="listproduct bn-right panel panel-default no-space-row">
    ...
    <div class="row">
        ...
        <?php if(!empty($banner)) { ?>
            <div class="banner effect-v10 hidden-sm hidden-xs col-lg-3 col-md-3">
                <a href="<?php echo $link; ?>"><img class="img-responsive" src="<?php echo $banner; ?>" alt="img" style="width:<?php echo $b_width;?>px;height:<?php echo $b_height;?>px"></a>
            </div>
        <?php } ?>
    </div>
</div>