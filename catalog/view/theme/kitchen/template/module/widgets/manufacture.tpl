<?php $id = rand(1,10); $span =  12/$columns; ?>
   <div class="widget-carousel panel panel-default owl-carousel-play carousel-ed slide <?php echo $addition_cls ?>  <?php if( isset($stylecls)&&$stylecls ) { ?>box-<?php echo $stylecls;?><?php } ?>">
	<?php if( $show_title ) { ?>
	...
	<?php } ?>
		...
		<div class="carousel-inner owl-carousel" data-show="1" data-pagination="false" data-navigation="true">
			...
			<div class="item <?php if($k==0) {?>active<?php } ?> space-padding-lr-10">
				<?php foreach( $tbanners as $i => $banner ) {  $i=$i+1;?>
					...
					<div class="col-lg-<?php echo $span;?> col-md-<?php echo $span;?> col-sm-<?php echo $span;?> col-xs-6">
		...
		<div class="carousel-controls">
			<a class="carousel-control left" href="#pavcarousel<?php echo $id;?>" data-slide="prev"><i class="zmdi zmdi-chevron-left"></i></a>
			<a class="carousel-control right" href="#pavcarousel<?php echo $id;?>" data-slide="next"><i class="zmdi zmdi-chevron-right"></i></a>
		</div>
		<?php } ?>
