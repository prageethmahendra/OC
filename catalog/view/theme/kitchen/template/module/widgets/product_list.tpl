<?php
	...
	$columns_count  = 1;
?>
<div class="panel panel-default <?php echo $addition_cls;?>">
	<?php if( $show_title ) { ?>
	...
	<div class="list box-products owl-carousel-play  <?php if ( isset($stylecls)&&$stylecls) { ?>box-<?php echo $stylecls; ?><?php } ?>" id="product_list<?php echo $id;?>" data-ride="owlcarousel">
