<div class="effect-v10 call-to-action text-center bg-calltoaction <?php echo $style;?> <?php echo $addition_cls; ?>">
    ...
    <div class="call-to-action-inner action-button">
    	<?php if($text_link_1){?>
        	<a class="btn  btn-outline" href="<?php echo $link_1;?>"><?php echo $text_link_1;?></a>
        <?php }?>
        <?php if($text_link_2) {?>
        	<a class="btn  btn-outline-light" href="<?php echo $link_2;?>"><?php echo $text_link_2;?></a>
        <?php }?>
    </div>
    <?php }?>
</div>