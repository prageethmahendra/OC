...
<div class="product-tabs panel <?php $addition_cls?> <?php if ( isset($stylecls)&&$stylecls) { ?>box-<?php echo $stylecls; ?><?php } ?>">
	<?php if( $show_title ) { ?>
	 ...
	 <div class="tab-content hightlight">
		<?php foreach( $tabs as $tab => $products ) {
			...
			?>
				...
				<a class="carousel-control left" href="#tab-<?php echo $tab.$id;?>"   data-slide="prev"><i class="zmdi zmdi-chevron-left"></i></a>
				<a class="carousel-control right" href="#tab-<?php echo $tab.$id;?>"  data-slide="next"><i class="zmdi zmdi-chevron-right"></i></a>
				</div>
				<?php } ?>
