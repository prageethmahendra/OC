<div class="blogs-item">
	...
	<div class="blog-meta">
		...
		<?php if( $cat_show_readmore ) { ?>
				<a href="<?php echo $blog['link'];?>" class="btn btn-outline btn-second btn-xs"><?php echo $objlang->get('text_readmore');?><i class="text-primary zmdi-hc-fw zmdi zmdi-chevron-right"></i></a>
			<?php } ?>
		</div>
	</div>
</div>
