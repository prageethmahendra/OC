<div id="accordion" class="tab-group accordion">
    <ul class="nav nav-pills nav-stacked">
        <li>
            <a data-toggle="collapse" href="#collapse1"><?php echo $tab_description; ?></a>
        ...
        <li>
            <a data-toggle="collapse" href="#collapse2"><?php echo $tab_attribute; ?></a>
        ...
        <li>
            <a data-toggle="collapse" href="#collapse3"><?php echo $tab_review; ?></a>
        ...
        <?php } ?>
         ...
         <li>
             <a data-toggle="collapse" href="#collapse4"><?php echo $productConfig['product_customtab_name'][$languageID]; ?></a>
