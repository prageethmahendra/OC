		...
		<div id="sidebar-main" class="<?php echo $class; ?>">
			<div id="content">
				<div class="pavdeals tab-group">
					<ul class="nav nav-tabs deals-option text-center">
					...
					<div class="row filter">
						<div class="col-md-2">
							<div class="display group-switch hidden-xs">
								<button type="button" id="list-view" class="btn btn-link btn-switch" data-toggle="tooltip" title="<?php echo $objlang->get("button_list"); ?>"><i class="zmdi zmdi-format-list-bulleted"></i></button>
		            			<button type="button" id="grid-view" class="btn btn-link btn-switch active" data-toggle="tooltip" title="<?php echo $objlang->get("button_grid"); ?>"><i class="zmdi zmdi-border-all"></i></button>
							</div>
						</div>
